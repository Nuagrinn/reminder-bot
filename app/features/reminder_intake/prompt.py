...
def build_system_prompt(request: ReminderParseRequest) -> str:
    return (
        ...
        "date/time, recurrence, and optional notification offset. Return only "
        ...
        "- birthdays use event_type='birthday' and yearly recurrence;\n"
        ...
        "time='15:30', start_at='2026-07-25T15:30:00'.\n"
        "- 'tomorrow top up card' -> once, date=tomorrow, time=null, "
        "all_day=true, notification_offsets=[].\n"
        "- 'in 2 hours check oven' -> once with exact start_at.\n"
        "- 'every two days check mail' -> recurring daily interval=2.\n"
